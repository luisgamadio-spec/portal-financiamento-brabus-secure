-- Incidente RBAC-Analista-Fandi-Store-Scope -- corrige rejeicao falsa de
-- perfis store-scoped (ANALISTA/GERENTE/VENDEDOR) na propria loja em
-- operational_fandi_dashboard, e a consequente ausencia de dados mesmo
-- quando a autorizacao passa.
--
-- CAUSA (comprovada por 3 fases de diagnostico read-only, 0 escrita em
-- producao ate este patch):
--
